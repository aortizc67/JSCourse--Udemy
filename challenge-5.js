...
8. After you display the result, display the next randome question, so that the game never ends (HINT: write a function for this and call it
...
// 5 ----------------------------------
var userAnswer = parseInt(prompt("Type the correct answer"));

questionsArray[random].checkAnswer(userAnswer);



/* IIFE - This one way to do this, the course does this in a different way.

(function chooseQuestion()
{
    chosenQuestion = questionsArray[Math.floor(Math.random() * questionsArray.length)];
